...
See `docs/PHASE1_BLOCK_ENGINE.md`, `docs/PHASE2_SLASH_TOOLBAR.md`, `docs/PHASE3_PAGE_TREE_DRAWER.md`, `docs/PHASE3_5_PERSISTENCE_SEARCH_ARCHIVE.md`, `docs/PHASE4_DATABASE_CORE.md`, `docs/PHASE4_5_SHELL_ALIGNMENT.md`, `docs/PHASE5_STUDIO_MODULE_MOUNT.md`, `docs/PHASE6_SHARED_SHELL_FOUNDATION.md`, `docs/PHASE7A_DATABASE_LIST_TABLE.md`, `docs/PHASE8_STUDIO_COMMAND_CENTER.md`, `docs/PHASE9_RECORD_PAGES_SAVED_VIEWS.md`, `docs/PHASE10_BOARD_VIEW.md`, and `docs/PHASE11_GALLERY_VIEW.md`.
